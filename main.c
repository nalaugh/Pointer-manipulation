...
void printArrayPointerValue(int** array, int size);
...
int main(int argc, char *argv[]) {
    ...
    printf("%d list\n\nPrints the sorted lines prior to sort\n", numLine);
    ...
    printArray(original, numLine);//printing the original order
    ...
    {
        printArrayPointerValue((line + *(shift + i)), *(final+i));//Print the final array
    }
    //freeing the memory
    free(line);
    free(final);
...
/***********************************************
 * Description: print the array
 * Input: the pointer to the pointer to be printed and the size
 * Output: the printed list.
***********************************************/
void printArrayPointerValue(int **array, int size)
{
